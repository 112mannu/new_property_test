  ...
  <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
      <div class="container mx-auto px-6 py-2">
          <div class="text-right">
            @can('form1 create')
              <a href="{{route('admin.form.create')}}" class="bg-blue-500 text-white font-bold px-5 py-1 rounded focus:outline-none shadow hover:bg-blue-500 transition-colors ">New post</a>
            @endcan
          </div>
              ...
              @can('form1 access')
                ...
                <td class="py-4 px-6 border-b border-grey-light">{{$forms->email}}</td>
                  ...
                  <td class="py-4 px-6 border-b border-grey-light text-right">
                    ...
                    @can('form1 delete')
                    <form action="{{ route('admin.form.destroy', $forms->id) }}" method="POST" class="inline">
                        @csrf
                        @method('delete')
