          ...
          <tbody>
            ...
            <tr class="hover:bg-grey-lighter">
              ...
              <td class="py-4 px-6 border-b border-grey-light text-right">
                ...
                @can('Municipal edit')
                <a href="{{route('admin.municipal.edit',$municipal->id)}}" class="text-grey-lighter font-bold py-1 px-3 rounded text-xs bg-green hover:bg-green-dark text-blue-400">Edit</a>
                @endcan
