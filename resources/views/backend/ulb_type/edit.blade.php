            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="breadcrumb-item active">Update ULB TYPE</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="ulbtype" value="{{ old('ulbtype',$ulbtype->ulbtype) }}" type="text" placeholder="Urban Local Bodies Type">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="remark" class="mb-1">Remark</label>
                                    <input class="form-control" type="text"  name="remark" value="{{ old('remark',$ulbtype->remark) }}" placeholder="Remark">
                                </div>
                            </div>
