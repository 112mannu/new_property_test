            ...
            <div class="card-header">
                ...
                <div class="card-body order-datatable pt-2">
                    <div class="btn-popup pull-right">
                        <a href="{{route('admin.users.create')}}"> <button type="button" class="btn btn-primary">Add User</button></a>
                    </div>
                </div>
                        ...
                        <table class="display table jsgrid dataTable no-footer" id="basic-1" role="grid" aria-describedby="basic-1_info">
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="basic-1" rowspan="1" colspan="1" aria-label="Image: activate to sort column ascending" style="width: 184px; ">User Name</th>
                                    <th class="sorting" tabindex="0" aria-controls="basic-1" rowspan="1" colspan="1" aria-label="User Name: activate to sort column ascending" style="width: 100px; min-width:100px;">Role</th>
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="basic-1" rowspan="1" colspan="1" aria-label="Mobile: activate to sort column ascending" style="width: 184px;">Login Id </th>
