                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <select id="status" name="state_id" class="form-control" >
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="validationCustom01" class="mb-1">ULB Name*</label>
                                        <input class="form-control" type="tesx" name="name" placeholder="UBL Name">
                                    </div>
                                </div>

                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="Code" class="mb-1">ULB Code*</label>
                                        <input class="form-control" name="ulb_code"  placeholder="ULB Code">
                                    </div>
                                </div>
