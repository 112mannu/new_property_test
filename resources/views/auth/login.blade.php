...
<x-guest-layout>
      <div class="font-sans min-h-screen antialiased bg-gray-900 pt-24 pb-5">
        <div class="flex flex-col justify-center sm:w-96 sm:m-auto mx-5 mb-5 space-y-8">
          <h1 class="font-bold text-center text-4xl text-yellow-500">Nagar Sahayak <span class="text-blue-500">Login</span></h1>
            <!-- Session Status -->
          ...
          <form method="POST" action="{{ route('admin.login') }}">
            ...
            <div class="flex flex-col bg-white p-10 rounded-lg shadow space-y-6">
              ...
              <div class="flex flex-col space-y-1">
                <input type="unique_id" name="unique_id" id="" class="border-2 rounded px-3 py-2 w-full focus:outline-none focus:border-blue-400 focus:shadow" placeholder="User Name" :value="old('unique_id')" required autofocus />
              </div>
