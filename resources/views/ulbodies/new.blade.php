    ...
    <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
      <div class="container mx-auto px-6 py-1 pb-16">
        <div class="bg-white shadow-md rounded my-6 p-5">
          <form method="POST" action="{{ route('admin.ulbodies.store') }}">
            @csrf
           <div class="row">
           <label for="ulbtype" class="text-gray-700 select-none font-medium mb-2">Urban Local Bodies Type *</label>
            ...
            <div class="flex flex-col space-y-2 col-lg-4 mt-3">
              ...
              <input type="text" name="city" placeholder="City/Town" class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200" />
            </div>


            <div class="flex flex-col space-y-2 col-lg-4 mt-3">
              <label class="text-gray-700 select-none font-medium">Code </label>
              <input type="text" name="code" placeholder="Code" class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200" />
            </div>
